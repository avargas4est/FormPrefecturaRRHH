    ...
    public partial class frmHome : Form
    {
        ...
        private void DisableButton()
        {
            foreach (Control previousBtn in panelMenu.Controls)
            {
                ...
                {
                    previousBtn.BackColor = Color.FromArgb(255, 215, 0);
        ...
        private void Reset()
        {
            DisableButton();
            lblTitle.Text = "HOME";
            panelTitleBar.BackColor = Color.FromArgb(21, 71, 52);
            panelLogo.BackColor = Color.FromArgb(218, 165, 32);
            currentButton = null;
            btnCloseChildForm.Visible = false;
        }
        ...
        {
            OpenChildForm(new Forms.Home.Dashboard(), sender);
        }
